...
function Counter() {
   ...
   const handleIncrement =()=>{
    ...
    return (
        <div style={{ height: '70vh' }} className='w-100 d-flex justify-content-center align-item-center mt-5'>
            <div className='d-flex justify-content-center align-items-center border rounded p-5 w-50 flex-column'>
                ...
                <div className='d-flex mt-5'>
                    <input type="text" className='form-control' placeholder='Enter the amount to be incremented!!!' onChange={(e)=>setAmount(e.target.value)} />
